...
export default function BetaflightLayout({ children }: Props) {
    ...
    return (
        ...
        >
            ...
            >
                <svg
                    className="max-w-full h-fit origin-top"
                    id="visual"
                ...
                >
                    <g>
                        <g transform="translate(2667 701)">
                            <path
                                d="M0 -105.2L91.1 -52.6L91.1 52.6L0 105.2L-91.1 52.6L-91.1 -52.6Z"
                                fill="none"
                                stroke="#FFBB00"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1916 66)">
                            <path
                                d="M0 -88L76.2 -44L76.2 44L0 88L-76.2 44L-76.2 -44Z"
                                fill="none"
                                stroke="#FFBB00"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(375 976)">
                            <path
                                d="M0 -53L45.9 -26.5L45.9 26.5L0 53L-45.9 26.5L-45.9 -26.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1284 227)">
                            <path
                                d="M0 -103L89.2 -51.5L89.2 51.5L0 103L-89.2 51.5L-89.2 -51.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(550 534)">
                            <path
                                d="M0 -74L64.1 -37L64.1 37L0 74L-64.1 37L-64.1 -37Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1527 791)">
                            <path
                                d="M0 -56L48.5 -28L48.5 28L0 56L-48.5 28L-48.5 -28Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1873 860)">
                            <path
                                d="M0 -43L37.2 -21.5L37.2 21.5L0 43L-37.2 21.5L-37.2 -21.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1514 477)">
                            <path
                                d="M0 -38L32.9 -19L32.9 19L0 38L-32.9 19L-32.9 -19Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(60 630)">
                            <path
                                d="M0 -65L56.3 -32.5L56.3 32.5L0 65L-56.3 32.5L-56.3 -32.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1827 1186)">
                            <path
                                d="M0 -90L77.9 -45L77.9 45L0 90L-77.9 45L-77.9 -45Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(896 404)">
                            <path
                                d="M0 -82L71 -41L71 41L0 82L-71 41L-71 -41Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(553 1111)">
                            <path
                                d="M0 -77L66.7 -38.5L66.7 38.5L0 77L-66.7 38.5L-66.7 -38.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(92 961)">
                            <path
                                d="M0 -97L84 -48.5L84 48.5L0 97L-84 48.5L-84 -48.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(743 245)">
                            <path
                                d="M0 -31L26.8 -15.5L26.8 15.5L0 31L-26.8 15.5L-26.8 -15.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(7 126)">
                            <path
                                d="M0 -92L79.7 -46L79.7 46L0 92L-79.7 46L-79.7 -46Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1007 1103)">
                            <path
                                d="M0 -104L90.1 -52L90.1 52L0 104L-90.1 52L-90.1 -52Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(354 1189)">
                            <path
                                d="M0 -45L39 -22.5L39 22.5L0 45L-39 22.5L-39 -22.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(672 794)">
                            <path
                                d="M0 -44L38.1 -22L38.1 22L0 44L-38.1 22L-38.1 -22Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1751 550)">
                            <path
                                d="M0 -73L63.2 -36.5L63.2 36.5L0 73L-63.2 36.5L-63.2 -36.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(2435 195)">
                            <path
                                d="M0 -102L88.3 -51L88.3 51L0 102L-88.3 51L-88.3 -51Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(2442 641)">
                            <path
                                d="M0 -49L42.4 -24.5L42.4 24.5L0 49L-42.4 24.5L-42.4 -24.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(843 3)">
                            <path
                                d="M0 -91L78.8 -45.5L78.8 45.5L0 91L-78.8 45.5L-78.8 -45.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
                        ...
                        <g transform="translate(1631 994)">
                            <path
                                d="M0 -75L65 -37.5L65 37.5L0 75L-65 37.5L-65 -37.5Z"
                                stroke="#FFBB00"
                                fill="none"
                                stroke-width="8"
                            ></path>
