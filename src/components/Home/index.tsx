        ...
        <div className="w-full h-fit flex flex-col justify-center md:justify-start">
          ...
          <div className="p-4 xl:p-16 flex w-full justify-around flex-col xl:flex-row space-y-4 xl:space-y-0 space-x-0 xl:space-x-16">
            <div className="backdrop-blur-md shadow-xl w-full xl:w-1/2 flex xl:self-start self-center text-lg p-4 rounded-2xl bg-neutral-500/10">
              Betaflight is flight controller software (firmware) used to fly multi-rotor craft and fixed wing craft. This fork differs from Baseflight and Cleanflight in that it focuses on flight
              performance, leading-edge feature additions, and wide target support.
            </div>
        ...
        <HomepageFeature title="About" compact={true}>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 xl:gap-6 w-full">
            ...
            <AboutCard className="border-purple-600 text-purple-600" title="Flight Dynamics" Icon={JetIcon}>
              <p>
                Betaflight not only strives to put the best flight code on your controller, it also looks to satisfy such requirements as perfect performance, tiny footprint, full feature set and a
                strong quality assurance process.
              </p>
              <p>
                To assist in this endeavour all flight related data can be logged into a blackbox for later analysis. So pilots and technicians can objectively base their tune on the most appropriate
                data.
              </p>
            </AboutCard>
          </div>
          ...
          <div className="flex flex-col xl:flex-row gap-4 justify-center items-center">
            ...
            <div className="rounded-xl overflow-hidden max-h-[200px] xl:max-h-fit">
              <a href="https://www.hqprop.com/" target="_blank" rel="noreferrer">
                <img src="/img/sponsors/HQPROP.png" alt="HQProp" className="invert h-full w-auto" />
              </a>
            </div>
            <div className="rounded-xl overflow-hidden max-h-[200px] xl:max-h-fit">
          ...
          <div className="flex flex-col xl:flex-row space-x-4 justify-center items-center">
            <div className="flex flex-col space-y-4 text-white">
              ...
              <p>
                ...
                Saleae logic analysers, and other items to assist consistent contributors in their efforts. We are exceptionally grateful for those who do donate, either their time or funds.
              </p>
            </div>
