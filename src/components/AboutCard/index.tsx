    ...
    return (
        <div className="box flex flex-col w-full">
            <div
                className={clsx(
                    className,
                    `backdrop-blur-md relative flex text-lg md:text-xl xl:text-2xl w-fit font-semibold items-center bg-neutral-500/10 py-2 px-4 rounded-t-xl`,
                )}
            >
            ...
            <div className="shadow-xl backdrop-blur-md w-full h-full bg-neutral-500/10 p-4 rounded-b-xl rounded-r-xl text-gray-200 text-base">
                {children}
            </div>
        </div>
    );
