...
export default function AboutCard({
  ...
  return (
    <div className="box flex flex-col w-full">
      <div className={clsx(className, `backdrop-blur-md relative flex text-lg md:text-xl xl:text-2xl w-fit font-semibold items-center bg-neutral-500/10 py-2 px-4 rounded-t-xl`)}>
