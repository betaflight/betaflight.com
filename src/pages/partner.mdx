...
<p className="flex flex-col items-center">
  <img src="/img/sponsors/bf_partner_dark.svg" className="no-effect md:w-1/4 mt-6 mb-2"></img>
</p>

<p className="flex flex-col items-center">

<b className="text-xl text-primary-500">The 'Betaflight partner' manufacturers for release 4.4 are:</b>
