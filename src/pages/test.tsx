...
export default function Hello() {
	...
	return (
		...
		>
			...
			<div className="max-w-[1920px] m-auto flex flex-col items-center min-h-screen w-full">
				...
				<div className="w-full mt-40 flex flex-col items-center xl:items-start md:px-16 md:pt-16 p-6">
					<h2 className="text-primary-500 text-3xl font-bold my-4 ml-1">About</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 grid-rows-6 gap-6 w-full">
						<AboutCard 
							title="Hardware" 
