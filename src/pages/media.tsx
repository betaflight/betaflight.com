...
function IconElementFeature({
    ...
    link,
    children,
}: IconElementFeatureProps): JSX.Element {
    return (
        <div className="flex">
            ...
            <div className="ml-2">
                ...
                {link && (
                    <a
                        className="underline text-blue-400 flex items-center"
                        href={link.href}
                    >
        ...
        <BetaflightLayout>
            ...
            <div className="w-screen xl:max-w-[1920px] m-auto p-4 xl:p-16">
                <HomepageFeature title="Downloads">
                            ...
                            >
                                <div className="flex flex-col">
                                    <div className="text-gray-400 flex flex-row space-x-1 mt-2">
                                        ...
                                        <a
                                            href="https://github.com/betaflight/blackbox-log-viewer/releases"
                    ...
                    See BB Logging and Usage Wiki page on using the BlackBox
                    logger.
                                    </div>
                                </div>
                            </IconElementFeature>
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            >
                                <div className="flex flex-col">
                                    <a
                                        href="https://ci.betaflight.tech/job/Betaflight/lastBuild/artifact/obj/"
                                        className="text-blue-400 underline"
                                    >
                    Nightly builds
                                    </a>
                                    <a
                                        href="https://github.com/betaflight/betaflight-configurator-nightlies/releases"
                                        className="text-blue-400 underline"
                                    >
                    Betaflight Configurator Nightly builds
                                    </a>
                                    <a
                                        href="https://github.com/betaflight/betaflight-tx-lua-scripts-nightlies/releases"
                                        className="text-blue-400 underline"
                                    >
                    Betaflight TX Lua Scripts Nightly builds
                                    </a>
                                    <a
                                        href="https://github.com/betaflight/blackbox-log-viewer-nightlies/releases"
                                        className="text-blue-400 underline"
                                    >
                    ...
                    You can find release planning here:
                                        <a
                                            href="https://github.com/betaflight/betaflight/milestones"
                                            className="text-blue-400 underline"
                                        >
                      Release planning
                                        </a>
