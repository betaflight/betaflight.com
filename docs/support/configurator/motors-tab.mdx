...
[Configuration Tab](https://betaflight.com/docs/support/configurator/configuration-tab#other-features) and configure Air 
Mode on a switch in the [Modes Tab](https://betaflight.com/docs/support/configurator/modes-tab) so that Air Mode is 
