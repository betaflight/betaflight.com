...
- [Dynamic Idle](/docs/support/archive/Tuning-Dynamic-Idle), to improve handling at low rpm
...
These changes were originally described in the [ff_2.0 documentation](/docs/support/archive/Feed-Forward-2.0). There we explained the basics of what feed-forward and ff_boost are.
