...
Once you have connected to your flight controller, you will land on the [Setup Tab](/docs/support/configurator/setup-tab).
...
mistakes, and let you return to the original settings if needed. To do this, go to the [CLI Tab](/docs/support/configurator/cli-tab) tab and send either the
...
[Ports Tab](/docs/support/configurator/ports-tab). Enable `Serial RX` on the UART that your receiver is connected to.
...
in the [Receiver Tab](/docs/support/configurator/receiver-tab), we'll go over that right now

:::

Now that you have the `Serial RX` option enabled, you will need to set your receiver-specific settings in the
[Receiver Tab](/docs/support/configurator/receiver-tab). Whether you are using a pre-built drone or building your own,
...
[Channel Map](/docs/support/configurator/receiver-tab#channel-map) option accordingly.
...
will need to set up SmartAudio or Tramp in the [Ports Tab](/docs/support/configurator/ports-tab).

Enable `SmartAudio` or `Tramp` as a peripheral on the UART that your VTX is connected to, which you should hopefully
know. Then you can set up the VTX in the [VTX Tab](/docs/support/configurator/vtx-tab). It may seem overwhelming, but if
...
Start in the [Ports Tab](/docs/support/configurator/ports-tab) by enabling `VTX (MSP + Displayport)` as a peripheral on
...
Then in the [Preset Tab](/docs/support/configurator/presets-tab), there are a few system-specific presets that you can use to make the setup easier:
...
Compared to the other settings, motor settings are pretty simple. In the [Motors Tab](/docs/support/configurator/motors-tab),
...
In the [Modes Tab](/docs/support/configurator/modes-tab), you will see a list of all the modes that are available.
...
The OSD allows you to display information in the video feed from your quadcopter. In the [OSD Tab](/docs/support/configurator/osd-tab),
...
If not here, you can read the [troubleshooting](/docs/support/troubleshooting) page to see if you can find a solution. If
