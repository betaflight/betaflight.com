...
Usually also caused by missing drivers. You can install the drivers using the ImpulseRC Driver Fixer tool, which can be downloaded [here](https://impulserc.com/pages/downloads). You may also want to install all the necessary dirvers manually
