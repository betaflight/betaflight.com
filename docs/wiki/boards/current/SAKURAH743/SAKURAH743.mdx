...
{/_ fill the specs list above with the relevant information, don't change any of the keys unless you know what you're doing.
If a feature isn't present, just type "None". The target name should be the exact same as in the config repo,
the MCU, IMU, OSD and Baro should be the part name if applicable _/}
