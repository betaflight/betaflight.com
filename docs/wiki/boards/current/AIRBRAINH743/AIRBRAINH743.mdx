...
![AIRBRAINH743 Diagram](./AIRBRAINH743-images/AIRBRAINH743-diagram.png)
...
All other 5V outputs only work when powered through battery.
...
![UART + I2C Connector Schematic](/img/connector_standard/i2c_connector_schematic.png)

![UART + I2C Connector Board Render](/img/connector_standard/i2c_connector_render.png)
