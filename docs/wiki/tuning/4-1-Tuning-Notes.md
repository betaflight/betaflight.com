...
For a VTX to be controlled by Betaflight, [a suitable VTX table must be configured by the user](/docs/wiki/guides/current/VTX#vtx-tables) in a way that complies with local regulations.
