...
For a VTX to be controlled by betaflight, [a suitable VTX table must be configured by the user](/docs/development/VTX#vtx-table) in a way that complies with local regulations.
