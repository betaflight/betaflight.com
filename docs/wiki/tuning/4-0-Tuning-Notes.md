...
- [D_min](/docs/wiki/guides/archive/DMIN) _(archived — variables renamed in 2025.12)_, which dynamically adjusts the PID D parameter according to stick movement
