...
[Configuration Tab](/docs/wiki/app/configuration-tab#other-features) and configure Air
Mode on a switch in the [Modes Tab](/docs/wiki/app/auxiliary-tab) so that Air Mode is
...
For more information about DShot and RPM filtering, see the [DShot RPM Filtering guide](/docs/wiki/guides/current/DSHOT-RPM-Filtering).
