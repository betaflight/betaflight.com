...
upgrade it to a new, more modern wiki, which you're currently reading!

:::caution Work in progress

This wiki is still new. Very new. As of writing this, it's only 5 days since we started working on it. 
...
The new wiki is built with [Docusaurus](https://docusaurus.io/), which is far better than what the 
...
The wiki is split up into different sections. You can find the sidebar on the left side of the page, 
