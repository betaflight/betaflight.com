...
- If you are going to use [Oneshot125](/docs/wiki/guides/archive/Oneshot) _(archived — legacy protocol; DShot is the modern standard)_, you may need to enable that on your ESCs using a jumper or flashing them with the latest stable firmware and enable Damped Light in their settings, if it's supported. Refer to the ESCs' documentation or online discussions to determine this.
...
- [Using a LED strip](/docs/wiki/guides/current/LED-Strip-Functionality)
