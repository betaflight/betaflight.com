...
and MAX. Check the box for the channel you want to control the servo. Direction and Rate control is a weighting which 
controls the direction and range of the servo movement 
