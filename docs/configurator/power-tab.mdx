...
Set up all your power and battery related settings here. You can also see the current power measurements
...
* **MSP Sensor/OSD Slave** - *NEEDS REVIEW, FOR ONCE I HAVE NO IDEA WHAT THIS MEANS*
...
*PLEASE REVIEW, NOT SURE WHAT TO WRITE HERE*
