...
<p align="center">
  <img src={Bit} alt="DShot Bit" className="themeInvert" />
</p>
...
<p align="center">
  <img src={Gcr} alt="DShot GCR" className="themeInvert" />
</p>

We send this:

<p align="center">
  <img src={GcrOpt} alt="DShot GCR Optimized" className="themeInvert" />
</p>
