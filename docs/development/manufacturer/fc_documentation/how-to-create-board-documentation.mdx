...
Use an image in a square aspect ratio (1:1) for the first image in the document, and use consistent filetype naming for the images - for example `.JPG` and `.jpg` can cause conflicts and confusion.
