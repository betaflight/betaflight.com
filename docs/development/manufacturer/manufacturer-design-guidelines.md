...
| Bidirectional DSHOT | Two-Way DSHOT communication protocol to enable Electronic Speed Controller telemetry to be sent back to the flight controller                                                                   | [wiki](/wiki/guides/current/Bidirectional-DSHOT-and-RPM-Filter.md)                                                                                                                                                                                 |
...
| DSHOT               | Digital Shot Communication Protocol used for Flight Controller to Electronic Speed Controller                                                                                                   | [wiki](/wiki/guides/current/DSHOT-ESC-Protocol.md)                                                                                                                                                                                                 |
