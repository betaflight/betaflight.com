...
| Bidirectional DSHOT | Two-Way DSHOT communication protocol to enable Electronic Speed Controller telemetry to be sent back to the flight controller                                                                   | [wiki](/wiki/guides/current/DSHOT-RPM-Filtering.md)                                                                                                                                                                                                |
...
| DSHOT               | Digital Shot Communication Protocol used for Flight Controller to Electronic Speed Controller                                                                                                   | [wiki](/wiki/guides/archive/DSHOT-ESC-Protocol-3-1.md)                                                                                                                                                                                             |
