...
![Analog Camera Connector Schematic](/img/connector_standard/5_pin_camera_connector_schematic.png)

![Analog Camera Connector Board Render](/img/connector_standard/5_pin_camera_connector_render.png)
...
![4-pin Analog Camera Connector Schematic](/img/connector_standard/4_pin_camera_connector_schematic.png)

![4-pin Analog Camera Connector Board Render](/img/connector_standard/4_pin_camera_connector_render.png)
...
![3-pin Analog Camera Connector Schematic](/img/connector_standard/3_pin_camera_connector_schematic.png)

![3-pin Analog Camera Connector Board Render](/img/connector_standard/3_pin_camera_connector_render.png)
...
<a href="/img/connector_standard/connector-standard.kicad_sch" download="connector-standard.kicad_sch">
  Download
</a>
