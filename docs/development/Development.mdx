...
us out, check out the `#documentation` channel on the [Discord server](https://discord.betaflight.com/invite)
for more info.
...
Before starting to write code, please read our [development guidelines](development/Development.md) and [coding style definition](development/CodingStyle.md).
