...
| Bidirectional DSHOT | Two-Way DSHOT communication protocol to enable Electronic Speed Controller telemetry to be sent back to the flight controller                                                                   | [Support](/support/archive/Bidirectional-DSHOT-and-RPM-Filter.md)                                                                                                                                                                                        |
...
| DSHOT               | Digital Shot Communication Protocol used for Flight Controller to Electronic Speed Controller                                                                                                   | [Support](/support/archive/DSHOT-ESC-Protocol.md)                                                                                                                                                                                                        |
