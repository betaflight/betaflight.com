...
- Added support for accelerated [yaw spin recovery](/docs/support/archive/Yaw-Spin-Recovery-and-Gyro-Overflow-Detect) ([#5706](https://github.com/betaflight/betaflight/pull/5706));
