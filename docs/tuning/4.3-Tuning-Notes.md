...
1.  **We recommend using RPM based filtering** for best performance. Read about [enabling and configuring rpm filtering here.](/docs/support/archive/Bidirectional-DSHOT-and-RPM-Filter)
