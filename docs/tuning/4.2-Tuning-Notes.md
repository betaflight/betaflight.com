...
**NOTE 5**: We recommend using eRPM based filtering. Read about [enabling and configuring rpm filtering here.](/docs/support/archive/Bidirectional-DSHOT-and-RPM-Filter)
