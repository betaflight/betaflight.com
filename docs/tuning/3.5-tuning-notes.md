...
- If you are updating from pre-3.4, please read the [Betaflight 3.4 Tuning Notes](/docs/wiki/archive/Tuning-Tips-for-Betaflight-3.4) because they apply to 3.5 also.
