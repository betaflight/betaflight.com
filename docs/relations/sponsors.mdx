...
<div className="flex flex-col items-center backdrop-blur-md shadow-xl p-4 rounded-2xl bg-neutral-500/10 grid md:grid-cols-4 gap-4 mb-4">
  ...
  <a href="https://https://www.radiomasterrc.com/" target="_blank" rel="noreferrer noopener" className="flex flex-col items-center mb-4 xl:col-span-1 col-span-2 no-effect">
  ...
  <a href="https://www.tititop.com/" target="_blank" rel="noreferrer noopener" className="flex flex-col items-center xl:col-span-1 col-span-2 no-effect">
    <img alt="Dogcom" className="no-effect w-full" src="/img/betaflight/sponsors/dogcom.svg" />
  </a>
</div>
