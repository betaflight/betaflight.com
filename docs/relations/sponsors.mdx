...
<div className="flex flex-col items-center backdrop-blur-md shadow-xl p-4 rounded-2xl bg-neutral-500/10 grid md:grid-cols-4 gap-4 mb-4">
  <a href="https://www.hqprop.com/" target="_blank" rel="noreferrer noopener" className="flex flex-col items-center xl:col-span-1 col-span-2 no-effect">
    <img alt="HQProp" className="no-effect w-4/5 invertable" src="/img/betaflight/sponsors/hqprop.svg" />
  </a>
  <a href="https://www.radiomasterrc.com/" target="_blank" rel="noreferrer noopener" className="flex flex-col items-center mb-4 xl:col-span-1 col-span-2 no-effect">
    <img alt="Radiomaster" className="no-effect w-full invertable" src="/img/betaflight/sponsors/radiomaster.svg" />
  </a>
